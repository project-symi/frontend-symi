            ...
            <div>
              ...
              <div id="data-container">
                <div>
                  ...
                  <div className="data">
                    {
                      this.context.topEmployees ? this.context.topEmployees.sort((a,b) => b.points - a.points).map((employee, i) => {
                        return (
                          <div key={i} className="top">
                            <div className="top-num">{i + 1}</div>
                            <div>{employee.name}</div>
                            <div>{employee.points} ⭐️</div>
                            <div><Button size="small" color="primary" onClick={() => this.handleSwitchViewToInvite(employee)}>
                           invite
                            </Button></div>
                          </div>
                        );
